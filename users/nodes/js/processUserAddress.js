if (args.sourceData.ADDRESS_ID) {
  var addressFieldMap = { addressLine1: 'ADDRESS_LINE1', addressLine2: 'ADDRESS_LINE2', city: 'CITY', region: 'STATE_PROVINCE', postalCode: 'ZIP_POSTAL', countryId: 'COUNTRY', addressTypeId: 'ADDRESS_DESC' };
